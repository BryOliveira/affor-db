...
-- [Problem 1c]
-- Add at least two users into your user_info table
--  so that when we run this file,
-- we will have examples users in the database.

CALL sp_add_user('Pipithaniel', 'mypassisthebestword');
CALL sp_add_user('ChewyGranolaBar', 'wasmydinnertoday');
